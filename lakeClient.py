...
class LakeClient:
    ...
    def __init__(self, lakeName: str):
        try:
            self.serviceClient = DataLakeServiceClient(
                account_url="{}://{}.dfs.core.windows.net".format("https", lakeName),
                credential=AzureConfig["key"],
            )
    ...
    def uploadFile(
        ...
        try:
            fileSystemClient = self.serviceClient.get_file_system_client(
